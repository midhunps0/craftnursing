...
<x-slot:meta_tags>
    ...
    <div class="items-center">
        ...
        <div>
            <div class="relative">
                <img src="{{url('/images/about (1).webp')}}" width="100%" height="100%" class="lg:w-full xl:w-full 2xl:w-full h-auto lg:bg-cover hidden lg:block " alt="image of nursing student">
                <img src="{{url('/images/aboutphn.webp')}}" width="100%" height="100%" class=" w-full sm:w-full md:w-full h-auto bg-cover lg:hidden" alt="image of nursing student">
