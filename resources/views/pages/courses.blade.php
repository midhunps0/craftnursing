    ...
    <div class="items-center">
        ...
        <div>
            <div class="relative mt-2">
                <img src="{{url('/images/courses (1).webp')}}" class="lg:w-full xl:w-full 2xl:w-full h-auto lg:bg-cover hidden lg:block " alt="nursing college student image">
                <img src="{{url('/images/coursesphn (1).webp')}}" class=" w-full sm:w-full md:w-full h-auto  bg-cover lg:hidden" alt="nursing college student image">
