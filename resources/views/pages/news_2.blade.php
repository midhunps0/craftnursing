            ...
            <div class="lg:flex flex-row flex-grow">
                ...
                <div>
                    ...
                    <div class="lg:ml-3 lg:space-y-6">
                        <div>
                            <x-news-card-component :title="'Advancing Knowledge'" :src="url('/images/4.jpg')" :content="'The CRAFT School of'"  route="news" route_key="1" />
                        </div>
                        <div>
                            <x-news-card-component :title="'Advancing Knowledge'" :src="url('/images/4.jpg')" :content="'The  institution believe'"  route="news" route_key="2" />
                        </div>
                        <div>
                            <x-news-card-component :title="'Advancing Knowledge'" :src="url('/images/4.jpg')" :content="'The  CRAFT School of'"  route="news" route_key="3" />
                        </div>
                        <div>
                            <x-news-card-component :title="'Advancing Knowledge'" :src="url('/images/4.jpg')" :content="'The  institution believe'"  route="news" route_key="1" />
                        </div>
