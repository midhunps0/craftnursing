<x-guest-layout>
    <div class="items-center">
        ...
        <div class="xl:ml-24 xl:mr-24 2xl:ml-32 2xl:mr-32">
            <div class="lg:block lg:flex flex-col md:flex-row md:mt-16 lg:space-x-4 2xl:space-x-6 lg:ml-3 lg:mr-3 2xl:ml-8 2xl:mr-8">
                <div class="lg:w-1/3 2xl:w-1/3"><x-card-component cardtitle="Lamplighting Ceremony" :src="url('/images/1 craft-01 smallm.webp')" :image="url('/images/1 craft-01 big.webp')"  :cardcontent="'Renowned film director Kamal illuminates the dais with the symbolic lighting of the lamp, marking the commencement of the event with grace and reverence.'" route="news" route_key="1" /></div>
                <div class="lg:w-1/3 2xl:w-1/3"><x-card-component cardtitle="Lamplighting Ceremony" :src="url('/images/5 craft-01 smallm.webp')" :image="url('/images/5 craft-01 big.webp')"  :cardcontent="'Embracing lifelong learning, nurses pursue advanced degrees, certifications, and specialized training to remain adaptable and responsive to evolving healthcare needs.'" route="news" route_key="2" /></div>
                <div class="lg:w-1/3 2xl:w-1/3"><x-card-component cardtitle="Lamplighting Ceremony" :src="url('/images/7 craft-01 smallm.webp')" :image="url('/images/7 craft-01 big.webp')" :cardcontent="'Embracing lifelong learning, nurses pursue advanced degrees, certifications, and specialized training to remain adaptable and responsive to evolving healthcare needs.'" route="news" route_key="3" /></div>
            </div>
        </div>

        <div class="xl:ml-24 xl:mr-24 2xl:ml-32 2xl:mr-32">
            <div class="lg:block lg:flex flex-col md:flex-row md:mt-16 lg:space-x-4 2xl:space-x-6 lg:ml-3 lg:mr-3 2xl:ml-8 2xl:mr-8">
                <div class="lg:w-1/3 2xl:w-1/3"><x-card-component cardtitle="Lamplighting Ceremony" :src="url('/images/9 craft-01 smallm.webp')" :image="url('/images/9 craft-01 big.webp')"  :cardcontent="'Our chairman Prof. Dr. C Mohammed Ashraf,gracefully illuminating the path of knowledge during the ceremonial lighting of the lamp on the dais.'" route="news" route_key="1" /></div>
                <div class="lg:w-1/3 2xl:w-1/3"><x-card-component cardtitle="Lamplighting Ceremony" :src="url('/images/6 craft-01 smallm.webp')" :image="url('/images/6 craft-01 big.webp')"  :cardcontent="'Nursing students solemnly pledge to uphold the values of compassion, integrity, and excellence at the investiture ceremony, marking their commitment.'" route="news" route_key="2" /></div>
                <div class="lg:w-1/3 2xl:w-1/3"><x-card-component cardtitle="Lamplighting Ceremony" :src="url('/images/2 craft-01 smallm.webp')" :image="url('/images/2 craft-01 big.webp')" :cardcontent="'Captured: Our chairman and the esteemed film director engage in insightful dialogue, epitomizing the fusion of leadership and artistic vision.'" route="news" route_key="3" /></div>
            </div>
        </div>
