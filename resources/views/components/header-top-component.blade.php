<div>
    <div class="hidden md:block ">
        <div class=" hidden md:bg-primary md:flex flex-row p-2 ">
            <div class="md:flex flex-row md:w-1/3 md:ml-4 2xl:ml-28 2xl:mr-28">
            ...
            <div class="md:flex flex-row md:w-1/3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-5 w-4 fill-current text-white mt-1  items-center">
                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            <div class="md:flex flex-row md:w-1/3 md:mr-4">
