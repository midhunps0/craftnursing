...
<div>
    <div class="card-component">
        <div class="max-w-sm  mx-auto xl:mx-0 xl:ml-6 bg-white shadow-lg overflow-hidden mt-4 md:mt-8 lg:mt-4 mb-10">
            ...
            <img class="w-full object-cover cursor-pointer" src="{{ $src }}" alt="Card image" x-on:click="zoomed = !zoomed" >
            <div class=" flex justify-end " x-on:click="zoomed = !zoomed"><svg xmlns="http://www.w3.org/2000/svg" class="hidden md:block h-4 w-4 fill-current text-white relative stroke-3 -mt-4  p-px p-py rounded-md cursor-pointer" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM184 296c0 13.3 10.7 24 24 24s24-10.7 24-24V232h64c13.3 0 24-10.7 24-24s-10.7-24-24-24H232V120c0-13.3-10.7-24-24-24s-24 10.7-24 24v64H120c-13.3 0-24 10.7-24 24s10.7 24 24 24h64v64z"/></svg></div>
            <div x-show="zoomed ">
            ...
            <div class="px-6 pt-4 pb-6 mb-2">
                <!-- <a  class="cursor-pointer  shadow-md text-white bg-teal px-4 py-2 text-base md:text-lg 2xl:text-lg lg:text-base font-bold font-inter" @click.prevent.stop="$dispatch('linkaction', {route: '{{$route}}', link: '{{route($route,['id' => $route_key])}}'});" >Learn more</a> -->
            </div>
        </div>
    </div>
</div>