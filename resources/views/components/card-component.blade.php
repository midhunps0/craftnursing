...
<div>
    <div class="card-component">
        <div class="max-w-sm  mx-auto xl:mx-0 xl:ml-6 bg-white shadow-lg overflow-hidden mt-4 md:mt-8 lg:mt-4 mb-6">
            ...
            <img width="100%" height="100%" class="w-full sm:w-full md:w-full lg:w-full xl:w-full 2xl:w-full h-auto object-cover cursor-pointer" src="{{ $src }}" alt="Nursing student image" x-on:click="zoomed = !zoomed" >
            ...
            <div x-show="zoomed ">
                ...
                <div class=" flex justify-end "><button class="bg-teal p-4 text-white text-lg font-bold z-70 cursor-pointer" x-show="zoomed" x-on:click="zoomed = false">X</button></div>
                    <div class="h-screen flex justify-center items-center">
                        <div class="">
                            <img width="100%" height="100%" class="w-full lg:w-full xl:w-full 2xl:w-full h-auto" src="{{ $image }}" alt="Nursing student image" >
                        </div>
