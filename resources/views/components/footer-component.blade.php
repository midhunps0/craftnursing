            ...
            <div class="lg:flex flex-row-reverse lg:mt-4 lg:mb-4 mb-6 2xl:ml-28 2xl:mr-28">
                ...
                <div class="mt-12 md:mt-24 flex flex-row mb-6 lg:w-2/4 lg:ml-8 ml-8 md:ml-16 xl:ml-32 2xl:w-1/3">
                    ...
                    <div class="ml-10 -mt-4">
                        ...
                        <div class="border border-0 bg-gray-100 bg-opacity-40  rounded-lg h-20 w-36 lg:h-auto lg:mt-2"><img src="{{url('/images/craftfertility red.webp')}}" class="border border-white rounded-lg  w-14 ml-10 items-center lg:w-16 h-auto" alt="image"></div>
