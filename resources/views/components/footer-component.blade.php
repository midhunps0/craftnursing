        ...
        <div>
            <div class="relative">
                    ...
                    <div class="absolute inset-0 overflow-hidden  bg-gradient-to-r from-submarine/100 to-teal/10 lg:bg-gradient-to-r from-cyan/80 to-teal/10 flex flex-col lg:flex flex-col">
                        <div class="ml-6 mt-16 mb-20 md:mt-20 lg:mt-28 lg:ml-16 flex-grow lg:flex-grow">
                            <h class="font-inter text-white font-bold text-xl md:text-2xl lg:text-3xl 2xl:text-4xl">Fulfill Your Dreams Of A<br> Noble Career</h>
                            <div class="lg:mr-96 lg:pr-64"><p class="font-inter text-white font-normal leading-4 text-xs md:text-sm md:mt-4 lg:text-base lg:mt-8 lg:mr-0 2xl:text-xl">Discover the path to realizing your dreams of a noble career in nursing, where your skills, compassion, and dedication come together to create moments of profound impact and healing.</p></div>
                                <button class="text-center flex items-center font-arial font-bold md:text-base lg:text-xl 2xl:text-2xl text-white mt-6 bg-teal text-xs p-2 lg:mt-8 2xl:mt-12 lg:py-3 lg:px-5 mr-52" type="button">
                                            APPLY NOW
                        ...
                        <div class="lg:ml-6 lg:mr-0 2xl:mr-8 md:ml-4">
                            <ul class="list-disc text-white mt-6 lg:mt-0 2xl:mt-4 ">
                                <div class="lg:-mr-4"><h class="text-white text-base mb-2 font-inter 2xl:text-2xl  lg:text-lg lg:font-normal font-inter">Quick Links</h></div>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('home')}}', route: 'home'})"><p class="text-white font-inter font-light leading-6 text-xs mt-2 lg:font-normal">Home</p></a></li>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('courses')}}', route: 'courses'}); console.log('event dispatched');"><p class="text-white font-inter font-light leading-6 text-xs 2xl:text-base mt-2 lg:font-normal">Courses</p></a></li>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('about')}}', route: 'about'}); console.log('event dispatched');"><p class="text-white font-inter font-light leading-6 text-xs mt-2 2xl:text-base lg:font-normal">About Us</p></a></li>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('contact')}}', route: 'contact'}); console.log('event dispatched');"><p class="text-white font-inter font-light leading-6 text-xs 2xl:text-base mt-2 lg:font-normal">Contact Us</p></a></li>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('gallery')}}', route: 'gallery'}); console.log('event dispatched');"><p class="text-white font-inter font-light leading-6 text-xs 2xl:text-base mt-2 lg:font-normal">Gallery</p></a></li>
                            </ul>
                        </div>
